        ...
        <div>
            <div className="p-4 text-xl font-sans tracking-wide">Choose a template to create an impressive CV</div>
                <div className="grid sm:grid-cols-3 grid-rows-3 justify-center mx-auto w-fit gap-12 transform translate-y-10 relative">
                    ...
                    {/*Template1*/}
                    <div className="relative group sm:w-[27vw] h-[70vh] w-[50vw]" onClick={()=>createResume({resumeId:'1'})}>
                        <PlusSquare className="relative z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-0 
                        group-hover:opacity-100 transition-opacity"/>
                        <img className="absolute sm:w-[27vw] w-[50vw] h-[70vh] border-gray-500 border-2 top-0 group-hover:cursor-pointer" 
                    ...
                    {/*Template2*/}
                    <div className="relative group sm:w-[27vw] w-[50vw] h-[70vh]" onClick={()=>createResume({resumeId:'2'})}>
                        <PlusSquare className="relative z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-0 
                        group-hover:opacity-100 transition-opacity"/>
                        <img className="absolute sm:w-[27vw] w-[50vw] h-[70vh] border-gray-500 border-2 top-0 group-hover:cursor-pointer"
                    ...
                    {/*Template*/}
                    <div className="relative group sm:w-[27vw]w-[50vw] h-[70vh]" onClick={()=>createResume({resumeId:'3'})}>
                        <PlusSquare className="relative z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-0 
                        group-hover:opacity-100 transition-opacity"/>
                        <img className="absolute sm:w-[27vw] w-[50vw] h-[70vh] border-gray-500 border-2 top-0 group-hover:cursor-pointer" 

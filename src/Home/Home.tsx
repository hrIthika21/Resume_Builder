        ...
        <div className="flex flex-col h-screen w-full sm:flex-row">
          <div className="sm:h-screen flex-1 sm:w-[45vw]  relative
           h-[50vh] w-[full] flex items-center justify-center">
            ...
            <img className="h-[35vh] w-[30vw] sm:h-[60vh] sm:w-[25vw] md:h-[60vh] md:w-[25vw] md:mr-16 sm:mr-7" src="https://www.my-resume-templates.com/wp-content/uploads/2023/05/student-resume-example.jpg" alt="resume" />
          </div>
          <div className="sm:h-screen flex-1 sm:w-[55vw]
          h-full w-full flex justify-center items-center flex-col">
            <p className="font-semibold sm:-translate-y-32 -translate-y-3 sm:text-6xl mx-10 text-5xl">BEST RESUME BUILDER</p>
            ...
            <div className="grid justify-items-start w-full ml-20">
              <button className="px-10 py-5 text-white rounded-lg shadow-lg bg-gradient-to-r from-[#DD5E89] via-[#F7BB97] to-[#DD5E89] bg-[length:200%_auto] transition-all duration-500 hover:bg-right 
                        sm:-translate-y-11 translate-y-9 active:scale-50 tracking-wide font-semibold " onClick={buttonClick}>
                CREATE MY RESUME
              </button>
          </div>
          </div>
